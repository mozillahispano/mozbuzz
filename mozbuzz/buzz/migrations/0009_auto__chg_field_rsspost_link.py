...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RSSPost.link'
        db.alter_column('buzz_rsspost', 'link', self.gf('django.db.models.fields.URLField')(max_length=3000))


    def backwards(self, orm):
        
        # Changing field 'RSSPost.link'
        db.alter_column('buzz_rsspost', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))
