...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mention.country'
        db.add_column('buzz_mention', 'country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['buzz.Country'], null=True, blank=True), keep_default=False)

        # Adding field 'Mention.product'
        db.add_column('buzz_mention', 'product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['buzz.Product'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Mention.country'
        db.delete_column('buzz_mention', 'country_id')

        # Deleting field 'Mention.product'
        db.delete_column('buzz_mention', 'product_id')
