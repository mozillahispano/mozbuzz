...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mention.link'
        db.alter_column('buzz_mention', 'link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Mention.remarks'
        db.alter_column('buzz_mention', 'remarks', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Mention.link'
        raise RuntimeError("Cannot reverse this migration. 'Mention.link' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Mention.remarks'
        raise RuntimeError("Cannot reverse this migration. 'Mention.remarks' and its values cannot be restored.")
