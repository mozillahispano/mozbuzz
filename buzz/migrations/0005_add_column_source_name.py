...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mention.source_name'
        db.add_column('buzz_mention', 'source_name', self.gf('django.db.models.fields.TextField')(default='placeholder.com'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Mention.source_name'
        db.delete_column('buzz_mention', 'source_name')
