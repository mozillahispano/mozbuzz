...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('buzz_mention', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['buzz.Product'], null=True, on_delete=models.PROTECT))

        # Changing field 'Mention.country'
        db.alter_column('buzz_mention', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['buzz.Country'], null=True, on_delete=models.PROTECT))

    def backwards(self, orm):

        # Changing field 'Mention.product'
        db.alter_column('buzz_mention', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['buzz.Product'], null=True))

        # Changing field 'Mention.country'
        db.alter_column('buzz_mention', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['buzz.Country'], null=True))
    ...
    models = {
        ...
        'buzz.mention': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['buzz.Country']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['buzz.Product']", 'null': 'True', 'on_delete': 'models.PROTECT', 'blank': 'True'}),
        ...
        'buzz.rssfeed': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'feeds'", 'to': "orm['buzz.Product']"}),
